    ...
    <>
      ...
      <div className="w-full flex">
        <motion.p variants={fadeIn("", "", 0.1)} className="mt-3 text-secondary text-[17px] max-w-3xl leading-[30px]">
            Następujące projekty prezentują moje umiejętności i doświadczenie poprzez przykłady mojej pracy.
            Każdy projekt jest krótko opisany i zawiera linki do repozytoriów kodu.
        </motion.p>
      </div>
